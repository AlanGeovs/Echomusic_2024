    ...
    <div class="container">
        <div class="page-title-content">
            ...
            <ul>
                ...
                <li class="active">Registro de espacio</li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <form id="formRegistroUsuario" method="post" enctype="multipart/form-data">
                        <div class="row justify-content-center">
                            <div class="col-md-12 col-sm-12 d-flex justify-content-center">
                                <a class="box-btn google" href="registroConGoogle.php?u=3">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    <input id="space" name="space" class="form-control" type="text" placeholder="Nombre de Lugar o Espacio" required>
                                </div>
                            </div>
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">

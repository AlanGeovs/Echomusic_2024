                    ...
                    <form id="formRegistroUsuario" method="post" enctype="multipart/form-data">
                        <div class="row justify-content-center">
                            <div class="col-md-12 col-sm-12 d-flex justify-content-center">
                                <a class="box-btn google" href="registroConGoogle.php?u=1">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    <input id="nick_user" name="nick_user" class="form-control" type="text" placeholder="Nombre de Banda o Artista" required>
                                </div>
                            </div>
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">

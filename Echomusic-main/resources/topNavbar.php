...
<nav id="topNavbar" class="navbar navbar-expand-md navbar-light fixed-top bg-light pt-0 pb-0">
  ...
  <div class="container h-100 nav-w" >
    ...
    <a id="first-logo" class="navbar-brand h-100" href="index.php"><img src="images/logo_brand_4.png" class="h-100"></a>
    ...
    <div id="topNavbar2" class="">
      ...
      <div class="row">
        <div id="second-logo" class="col-md-1">
          <a class="navbar-brand h-100" href="index.php"><img src="images/logo_brand_3.png" class="img-logo"></a>
        </div>
              ...
              <ul class="nav navbar-nav">
                <li class="dropdown">
                  ...
                  <ul id="navbar-dropmenu-ul" class="dropdown-menu" role="menu">
                    ...
                    <li><a class="nav-link" href="about.php">Sobre Nosotros<span class="sr-only">(current)</span></a></li>
...
<div id="sidebarRight" class="sidebar">
  ...
  <?php if(isset($_SESSION['user']) && $_SESSION['user'] != ""){ ?>
    <ul class="sidebar-list">
      <li class="sidebar-item"><a href="dashboard.php" class="sidebar-anchor">Mi Panel de Control</a></li>
      <? if($_SESSION['type_user']=='1'): ?>
        <li class="sidebar-item"><a href="profile.php?userid=<?=$_SESSION['user']?>" class="sidebar-anchor">Mi Perfil</a></li>
      <? else:?>
      <? endif;?>
      <li class="sidebar-item"><a href="search.php" class="sidebar-anchor">Artistas</a></li>
      <li class="sidebar-item"><a href="calendar_echomusic.php" class="sidebar-anchor">Cartelera</a></li>
      <li class="sidebar-item"><a href="search_crowdfunding.php" class="sidebar-anchor">Crowdfunding</a></li>
      <li class="sidebar-item"><a href="about.php" class="sidebar-anchor">¿Qué es EchoMusic?</a></li>
      <li class="sidebar-item"><a href="contacto_empresas.php" class="sidebar-anchor">Asesoría Empresas</a></li>
      <li class="sidebar-item"><a href="/blog" class="sidebar-anchor">Blog</a></li>
      <li class="sidebar-item"><a href="startEvent.php" class="sidebar-anchor">Crear Evento</a></li>
      <li class="sidebar-item"><a href="logout.php" class="sidebar-anchor" onclick="signOut();">Cerrar Sesión</a></li>
    </ul>
  <?php }else{ ?>
    <ul class="sidebar-list">
      <li class="sidebar-item"><a href="login.php" class="sidebar-anchor">Iniciar Sesión</a></li>
      <li class="sidebar-item"><a href="register.php" class="sidebar-anchor">Registrate</a></li>
      <li class="sidebar-item"><a href="search.php" class="sidebar-anchor">Artistas</a></li>
      <li class="sidebar-item"><a href="calendar_echomusic.php" class="sidebar-anchor">Cartelera</a></li>
      <li class="sidebar-item"><a href="search_crowdfunding.php" class="sidebar-anchor">Crowdfunding</a></li>
      <li class="sidebar-item"><a href="about.php" class="sidebar-anchor">¿Qué es EchoMusic?</a></li>
...
<div class="modal-dialog">
 ...
 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    ...
    <div class="modal-header">
      ...
      <img src="images/logo_brand_3.png" class="modal-title logo-modal" id="loginModalLabel">
    ...
    <div class="modal-footer text-center">
      ...
      <a href="register.php" class="btn btn-outline-secondary text-orange">Regístrate en EchoMusic</a>

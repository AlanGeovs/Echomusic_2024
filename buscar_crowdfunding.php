...
if (isset($_GET["p"])) {
    $id = $_GET["p"]; 
    $region   = $_GET["reg"]; 
    $titleBusqueda = "Proyectos sobre ".$id;
                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-sm-5">
                                        <div class="form-group"> 
                                            <input type="text" class="form-control" id="p" name="p" required data-error="Buscar un proyecto" placeholder="Buscar proyecto"  <?php echo $valueEvento; ?>  />

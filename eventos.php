        ...
        <section class="feature-area bg-color ptb-100">
            <div class="container">
                <div class="row align-items-center ">
                    ...
                    <div class="col-lg-12  ">                        
                        <p>Inicio / <?php echo $resuestaBuscaGenero["name_genre"].' / '.$respuesta[0]["name_event"]; ?></p>
                        <br> 
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12">
                                ...
                                <span style="font-size: 15px">Evento presencial </span> 
                                 <br>
                                <span style="font-size: 12px">  	<?php echo $respuestaCiudadRegion[0]["name_city"]; ?> / Región	<?php echo $respuestaCiudadRegion[0]["name_region"]; ?></span><br>
...
//    echo  'No Hay Video';
    ...
    echo '
        <section class="home-contact-area home-2-contact pt-70">
            <div class="container"> 
...
//                    Si el artista no tiene género, buscamos en una tabla de generos aleatoria
                    if(empty($idGenero)){
                        $eventosRelacionados = Consultas::eventosRelacionadosSINGenero($idGenero);
                    }else{
                                ...
                                <div class="row text-center ">
                                    <div class="col-lg-6 col-sm-6">
                                        ...
                                        <a href="#" class="line-bnt"> 
                                            '.$respuestaCiudadRegion[$k]["name_region"].', '.$respuesta[$k]["name_location"].'
                                        </a>
                                    </div>
                                    ...
                                    if($eventosRelacionados[$k]["ticket_value"]==0 ){
                                        ...
                                        echo  '<h4>$ ' .number_format( ($eventosRelacionados[$j]["ticket_value"]+$eventosRelacionados[$j]["ticket_commission"]), 0, ',', '.'). '</h4>

...
class Items{   
	...
	//funcioan para buscar por marca
	function marca(){	
		if($this->marca) {
			$stmt = $this->conn->prepare("SELECT * FROM ".$this->itemsTable." WHERE marca LIKE ?");
			$stmt->bind_param("s", $this->marca);					
		} else {

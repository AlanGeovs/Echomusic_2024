...
if ($validar=="") {
	...
	if ($respuesta=="error") {
		header("Location: https://echomusic.genesysapp.com/dashboard/registrar_usuario.php?e=error");
	}elseif ($respuesta=="ok") {
		...
		if ($res=="ok") {
			header("Location: https://echomusic.genesysapp.com/dashboard/site.php");
		}elseif ($res=="error") {
			header("Location: https://echomusic.genesysapp.com/dashboard/registrar_usuario.php?e=error");
		}
	...
	header("Location: https://echomusic.genesysapp.com/dashboard/registrar_usuario.php?e=existe"); 
}

...
<!--                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <input id="userName" name="userName"  class="form-control" type="text"  placeholder="Nombre Completo" required>
                                        </div>
                                    </div>
<!--                                    <div class="col-md-12 col-sm-12 ">
                                        <div class="form-group">
...
<!--                                    <div class="col-md-12 col-sm-12">
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <input id="espacio" name="espacio"  class="form-control" type="text"  placeholder="Nombre de Agencia / Agente" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group"> 
                                            <select  name="tipoagente" id="tipoagente" class="form-control"  data-error="Selecciona u tipo de agente" required />                                            
